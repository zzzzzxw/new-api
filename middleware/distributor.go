...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.NewAPIError {
	...
	common.SetContextKey(c, constant.ContextKeyChannelReasoningEffortEnabled, channel.GetReasoningEffortEnabled())
	common.SetContextKey(c, constant.ContextKeyChannelReasoningEffortMapping, channel.GetReasoningEffortMapping())
