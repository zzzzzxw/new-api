...
export const CHANNEL_TYPES = {
  ...
  58: 'Advanced Custom',
  59: 'Grok Subscription (Build)',
} as const

const CHANNEL_TYPE_DISPLAY_ORDER: number[] = [
  1, 14, 33, 24, 43, 3, 41, 48, 59, 58, 42, 34, 20, 4, 40, 27, 25, 17, 26, 15,
...
export const GROK_SUBSCRIPTION_DEFAULT_MODELS = [
  'grok-4.5',
  'grok-4.3',
  'grok-build-0.1',
...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  59: 'Authorize with xAI below, or paste a Grok OAuth JSON credential',
}
