...
func (a *Adaptor) ConvertOpenAIResponsesRequest(c *gin.Context, info *relaycommon.RelayInfo, request dto.OpenAIResponsesRequest) (any, error) {
	...
	if err := normalizeInputIDs(&request); err != nil {
		return nil, err
	}
	if isCompact {
		return request, nil
...
// normalizeInputIDs rewrites any input item `id` field that does not start with
// "msg_" to have that prefix. The Codex backend validates that all IDs begin
// with "msg_". This handles legacy IDs generated by older chat→responses
// conversion code that used a "chatcmpl-..._msg_0" format.
func normalizeInputIDs(request *dto.OpenAIResponsesRequest) error {
